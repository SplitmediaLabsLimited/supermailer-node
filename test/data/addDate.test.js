...
test('Should set the proper attribute on the data object', () => {
  ...
  r.data.addDate('test', '2012-01-01');
  expect(r.attributes.test).toEqual('2012-01-01T00:00:00.000Z');
});
...
test('Should return 2018-12-23T00:00:00.000Z', () =>
  expect(recipient.data.addDate('test', '2018/12/23')).toEqual('2018-12-23T00:00:00.000Z'));
...
test('Should return null', () => expect(recipient.data.addDate('test', null)).toEqual(null));

test('Should return 2001-01-01T00:00:00.000Z', () =>
  expect(recipient.data.addDate('test', 1)).toEqual('2001-01-01T00:00:00.000Z'));
